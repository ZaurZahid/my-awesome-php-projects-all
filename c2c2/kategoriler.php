...
//303 pagination isi olan dersdir ona bax ele ?>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active clear products-container" id="list-view">
                                        ...
                                        <?php 
                                                       ...
                                                       INNER JOIN kullanici ON urun.kullanici_id=kullanici.kullanici_id where urun.kategori_id=:id and urun_durum=:urun_durum and urun_onecikar=:urun_onecikar order by urun_zaman limit 7
                                                          ");
                                                        ...
                                                        'id'=>$_GET['kategori_id']
                                                         ...
                                                         if($say==0){
                                                           echo "bu kotegoride birsey tapilmadi dostum:)";
                                                       }
                                                ...
                                                <div class="item-content">
                                                    <div class="item-info">
                                                        ...
                                                        <div class="item-sale-info">
                                                            <div  style="font-size:25px;" class="price"><?php echo $uruncek['urun_fiyat']?><span style="font-size:20px;">Azn</span></div>
                                                            <div class="sale-qty">Satis ( 0 )</div>
                                                        </div>
                                                    </div>
