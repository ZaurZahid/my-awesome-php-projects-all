...
if(basename($_SERVER['PHP_SELF'])==basename(__FILE__)){
  ...
  exit('sehifeye girmeye icazeniz yoxdur');
   ...
   basename($_SERVER['PHP_SELF']);echo"<br>";
   basename(__FILE__);echo"<br>";
}
?>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-box">
                        ...
                        <ul class="corporate-address">
                            <li><i class="fa fa-map-marker" aria-hidden="true"></i><a href="Phone(01)800433633"><?php echo $ayarcek['ayar_il']?></a></li>
                            <li><i class="fa fa-phone" aria-hidden="true"></i><?php echo $ayarcek['ayar_tel']?></li>
                            <li><i class="fa fa-fax" aria-hidden="true"></i><?php echo $ayarcek['ayar_mail']?></li>
