...
<div class="main-banner2-area">
    <div class="container">
        <div class="main-banner2-wrapper">
            <h1>Welcome To Udemy C2C2 project!</h1>
            <p>Axtar ...</p>
          <form action="arama-detay.php" method="POST">  
             <div class="banner-search-area input-group"> 
                <input class="form-control"required=""minlength="3" name="searchkeyword" placeholder="Axtar . . ." type="text"> 
...
<div class="newest-products-area bg-secondary section-space-default">
    <div class="container">
        <h2 class="title-default">One cixan urunler</h2>
    </div>
    <div class="container-fluid" id="isotope-container">
        ...
        $urunsor=$db->prepare("SELECT urun.urun_id,urun.kategori_id,urun.urun_ad,urun.urun_fiyat,
        urun.urunfoto_resimyol,urun.kullanici_id,urun.urun_durum,urun.urun_onecikar,
        kategori.kategori_ad, kategori.kategori_id,
        kullanici.kullanici_id, kullanici.kullanici_ad,kullanici.kullanici_soyad,kullanici.kullanici_magazafoto
        FROM urun INNER JOIN kategori ON urun.kategori_id=kategori.kategori_id 
        INNER JOIN kullanici ON urun.kullanici_id=kullanici.kullanici_id where urun_onecikar=:onecikar and urun_durum=:durum
        ...
        'durum'=>1 
            ...
            ?>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 yenigelen component">
