              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <select id="heard" class="form-control" name="banka_durum" required>
                  ...
                  <option style="color:green" value="1" <?php if ($bankacek['banka_durum'] == '1'){ echo 'selected=""'; } ?>>Aktif</option>



                  <option style="color:red" value="0" <?php if ($bankacek['banka_durum']==0) { echo 'selected=""'; } ?>>Pasif</option>
                  <!-- <?php 
