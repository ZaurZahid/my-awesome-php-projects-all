            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <select id="heard" class="form-control" name="urun_durum" required>
                  ...
                  <option style="color:green" value="1" >Aktif</option>



                  <option style="color:red" value="0" >Pasif</option>
             ...
             <div class="form-group">
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="urunkaydet" class="btn btn-success">Güncelle</button>
              </div>
            </div>
