              ...
              <tbody>
                ...
                $uruncek=$urunsor->fetch(PDO::FETCH_ASSOC);
                 ...
                 if($yorumcek['yorum_onay']==0){?>
                        <a href="../netting/islem.php?yorum_id=<?php echo $yorumcek['yorum_id']?>&yorum_onay=1&yorum_onecikar=ok"> <button class="btn btn-success btn-xs">Onayla</button>    </a>
                       <?php    }  elseif($yorumcek['yorum_onay']==1){?>
                        <a href="../netting/islem.php?yorum_id=<?php echo $yorumcek['yorum_id']?>&yorum_onay=0&yorum_onecikar=ok"> <button class="btn btn-warning btn-xs">Kaldir</button>    </a>
