                ...
                <!-- ust banner finish -->
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 col-lg-pull-9 col-md-pull-8 col-sm-pull-8">
                        <div class="fox-sidebar">
                           ...
                           <li><a href="login" class="buy-now-btn" id="buy-button"><i class="fa fa-envelope-o" aria-hidden="true"></i> Mesaj gonder</a></li>

                            <?php }
                            
                           else if ($_SESSION['userkullanici_id']==$_GET['kullanici_id']) { ?>
                                <li><button disabled="" class="buy-now-btn" id="buy-button"><i class="fa fa-ban" aria-hidden="true"></i> Mesaj gonder</button></li>
                           <?php  } else {?>
                                <li><a href="mesaj-gonder?kullanici_gelen=<?php echo $_GET['kullanici_id']?>" class="buy-now-btn" id="buy-button"><i class="fa fa-envelope-o" aria-hidden="true"></i> Mesaj gonder</a></li>
                          <?php } ?>
                              </ul>
                    ...
                    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active in" id="Products">
                                <h3 class="title-inner-section">Menim mehsullarim</h3>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6">
                                            <div class="more-product-item">
                                                ...
                                                <div class="more-product-item-details">
                                                    ...
                                                    <div class="p-price"><?php echo $uruncek['urun_fiyat']?>Azn</div>
                                                </div>
                                            </div>
                                        </div>
                                                     <?php } ?>
