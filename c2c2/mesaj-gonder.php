                                    ...
                                    <div class="tab-pane fade active in" id="Personal">
                                        ...
                                        <div class="personal-info inner-page-padding"> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" disabled="" name="kullanici_gelen"  value="<?php echo $kullanicicek['kullanici_ad']." ".$kullanicicek['kullanici_soyad']?>" id="first-name" type="text">
                                                </div>
                                            </div>
            ...
            <input type="hidden" name="kullanici_gelen" value="<?php echo $_GET['kullanici_gelen']?>">
                                            <div class="form-group">
                                                 <div align="right" class="col-sm-12">
                                                   <button  class="update-btn" name="mesajgonder" type="submit" id="login-update">Mesaj gonder</button>
