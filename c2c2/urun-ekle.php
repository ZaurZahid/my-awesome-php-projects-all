                                    ...
                                    <div class="tab-pane fade active in" id="Personal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" name="urun_ad"  placeholder="Urun adi...." id="first-name" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                <textarea class="ckeditor" id="editor1" name="urun_detay" placeholder="Urun aciqlamasi...."></textarea>
                                                 </div>
                                            </div>
                              <script type="text/javascript">
...

                                  {
                                       ...
                                       forcePasteAsPlainText: true
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" name="urun_fiyat"  placeholder="Urun Fiyati...." id="first-name" type="text">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                 <div align="right" class="col-sm-12">
                                                   <button  class="update-btn" name="magazaurunekle" type="submit" id="login-update">Urun ekle</button>
