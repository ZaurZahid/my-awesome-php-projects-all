                        ...
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <textarea class="short-editor" name="post_short_content" ><?= post('post_content')?></textarea>
                             </div>
                          </div>
                        </div> 
                        <div class="row">
                            ...
                            <div class="form-group">
                              <label class="bmd-label-floating">Status</label> 
                                <select name="post_status"> 
                                   <option value="1" <?=post('post_status')==1 ? 'selected' : null?>>Yayinda</option>
                                   <option value="2" <?=post('post_status')==2 ? 'selected' : null?>>Yayina hazirlanir(Qaralama)</option>
                                </select> 
                           </div>
                          </div>
                        </div> 
                            ...
                            <div class="form-group">
                              <label class="bmd-label-floating">Ana Menu</label>
                                <select name="post_menu" style="width: 300px;" multiple="" size="6">
                                  ...
                                  <?php if($menu['submenu']):?><?php foreach($menu['submenu'] as $submenu):$suburl=ltrim($submenu['url'],'/its/');?><option style="color:#d81e55;font-weight:540;" value="<?=$suburl?>">............=><?=$submenu['title']?></option>
                        ...
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="post_url" value="<?=post('post_url')?>">
                        ...
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <input type="text"  name="post_seo[title]" class="form-control">
                            </div>
                          </div> 
                        </div>
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <textarea class="editor" name="post_seo[description]" rows="5"></textarea>
                            </div>
                          </div>
                        </div> 
                      </div>
