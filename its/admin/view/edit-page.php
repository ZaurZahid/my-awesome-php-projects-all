                        ...
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <input type="text"  name="page_title" value="<?=post('page_title')? post('page_title') : $row['page_title']?>" class="form-control">
                            </div>
                          </div> 
                        </div>
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <textarea class="form-control editor" name="page_content" cols="30" rows="5"><?= post('page_content')? post('page_content') : $row['page_content']?></textarea>
                             </div>
                          </div>
                        </div> 
                        <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="page_url" value="<?=post('page_url')? post('page_url') : $row['page_url']?>">
                        ...
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <input type="text"  name="page_seo[title]" class="form-control" value="<?= $seo['title']?>">
                            </div>
                          </div> 
                        </div>
                        <div class="row">
                          <div class="col-md-8">
                            <div class="form-group">
                              ...
                              <textarea class="form-control editor" name="page_seo[description]" rows="5"><?= $seo['description']?></textarea>
                            </div>
                          </div>
                        </div> 
                      </div>
                      
                      <button type="submit" name="submit" value="1" class="btn btn-primary pull-right">Guncelle</button>
