...
function cut_text($str,$limit=220){
    $str=strip_tags(htmlspecialchars_decode($str));//php ve html atiketlerinden sil yeni, ancaq bos text qalsin
    $length=strlen($str);
    if($length>$limit){
...
//seflink funksiyasi  //ə-ni ozum deyisdim
function permalink($str, $options = array())
 {
     ...
     $char_map = array(
         ...
         'Ø' => 'O', 'Ù' => 'U', 'Ú' => 'U', 'Û' => 'U', 'Ü' => 'U','Ə' => 'E','Ű' => 'U', 'Ý' => 'Y', 'Þ' => 'TH',
         'ß' => 'ss',
         'à' => 'a', 'á' => 'a', 'â' => 'a', 'ã' => 'a', 'ä' => 'a', 'å' => 'a', 'æ' => 'ae', 'ç' => 'c',
         'è' => 'e', 'é' => 'e', 'ê' => 'e', 'ë' => 'e', 'ì' => 'i', 'í' => 'i', 'î' => 'i', 'ï' => 'i',
         'ð' => 'd', 'ñ' => 'n', 'ò' => 'o', 'ó' => 'o', 'ô' => 'o', 'õ' => 'o', 'ö' => 'o', 'ő' => 'o',
...
echo permalink($deger);vvvvvvvvvvvvvvvv */
