    ...
    <div class="box-" tab>
        ...
        <div class="tab-container">
            <div tab-content>
                <ul> 
                        ...
                        <li>
                            ...
                            <div class="form-content">
                              <textarea class="editor" name="page_content" cols="30" rows="5"><?= post('page_content')?></textarea>
                            </div>
                        </li>
                   </ul>
            </div>
            <div tab-content>
                <ul>   
                    ...
                    <li>
                        ...
                        <div class="form-content">
                        <textarea  class="editor"  name="page_seo[description]" id="" cols="30" rows="5"></textarea>
                        </div>
                    </li>
                  </ul> 
            </div> 
            <ul> 
                ...
                <li class="submit">
                    <button type="submit">Sehifeni Kaydet</button>
                </li> 
           </ul>
      </div>   
