            ...
            <div tab-content>
                <ul> 
                        ...
                        <li>
                            ...
                            <div class="form-content">
                              <textarea class="editor-short" name="post_short_content" ><?= post('post_short_content') ? post('post_short_content') : $row['post_short_content']?></textarea>
                            </div>
                        </li>
                        <li>
                            <label>Movzu iceriyi</label>
                            <div class="form-content">
                              <textarea class="editor" name="post_content" cols="30" rows="5"><?= post('post_content') ? post('post_content') : $row['post_content']?></textarea>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="form-content">
                                <select name="post_status"> 
                                   <option value="1" <?=(post('page_status')?post('page_status'):$row['post_status'])==1 ? 'selected' : null?>>Yayinda</option>
                                   <option value="2" <?=(post('page_status')?post('page_status'):$row['post_status'])==2 ? 'selected' : null?>>Yayina hazirlanir(Qaralama)</option>
                                </select>         
                            </div>
                        </li> 
                        <li>
                            ...
                            <div class="form-content"> 
                              <input name="post_tags" id="tags" class="tagsinput" value="<?= post('post_tags') ? post('post_tags') : implode(',',$postTags)?>">   
            ...
            <div tab-content>
                <ul>   
                    ...
                    <li>
                        ...
                        <div class="form-content">
                        <textarea  class="editor"  name="post_seo[description]" id="" cols="30" rows="5"> <?=$seo['description']?></textarea>
                        </div>
                    </li>
                  </ul> 
            </div> 
