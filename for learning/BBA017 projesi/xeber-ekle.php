                            ...
                            <form action="nedmin/netting/adminislem.php" method="POST"  enctype="multipart/form-data" class="form-horizontal" id="personal-info-form">
                                <div class="settings-details tab-content">
                                    <div class="tab-pane fade active in" id="Personal">
                                        <h2 style="color:red" class="title-section">Bugunun xeberini elave et Dostum:)</h2>
                                        <div class="personal-info inner-page-padding"> 
                                              
       
                                        <div class="form-group">
                                                <label class="col-sm-3 control-label">Xeber ucun sekil*</label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                <textarea class="ckeditor" id="editor1" name="xeber_detay">  </textarea>
                                                 </div>
                                            </div>
              ...
              forcePasteAsPlainText: true
                                            ...
                                            <div class="form-group">
                                                 <div align="right" class="col-sm-12">
                                                   <button  class="btn btn-success" name="xeberekle" type="submit" id="login-update">Xeberinizi elave edin.</button>
