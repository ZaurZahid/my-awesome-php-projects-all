			        	...
			        	<?php }
                                 ...
                                 <div class="settings-details tab-content">
                                    <div class="tab-pane fade active in" id="Personal">
                                        <h2 style="color:red" class="title-section">Geden Mesajlariniz Dostum:)</h2>
...
$mesajsor=$db->prepare("SELECT mesaj.*,kullanici.* FROM mesaj
 inner join kullanici on mesaj.kullanici_mesajgelen=kullanici.kullanici_id
 where mesaj.kullanici_mesajgonderen=:id
...
?>
                                          ...
                                          <tr>
                                            ...
                                            <td><a href="mesaj_detay.php?gedenmesaj=ok&mesaj_id=<?php echo $mesajcek['mesaj_id']?>&kullanici_mesajgonderen=<?php echo $mesajcek['kullanici_mesajgonderen']?>">
                                             <button class="btn btn-primary btn-xs"> Oxu</button></a></td>
                                            <td>
                                            <a href="nedmin/netting/kullanici.php?mesajsil=ok&mesaj_id=<?php echo $mesajcek['mesaj_id']?>
